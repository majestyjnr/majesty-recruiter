...
?>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>User</td>
                        <td><a href="blockuser.php?id=<?php echo $id;?>">Block User</a></td>
                      </tr>
...
?>
                      <tr>
                        <td colspan="6" class="style3"><br><br><div align="left" class="style12"><?php echo "<center>Total Records of Registered Users = <b>".$records." Users</b></center>"; ?> </div></td>
                      </tr>
                      </table>
                      <?php
...
<center><h3 style ="color: red">All Blocked Users</h3></center>

<!-- Main content -->
<div class="content">
      <div class="card">
      <div class="card-body">
      <h4 class="text-black">Report of all blocked users</h4>
      <p>Export data to Copy, CSV, Excel & Note</p>
      <div class="table-responsive">
                  <table id="example2" class="table table-bordered table-hover" data-name="cool-table">
                    <thead>
...
// Specify the query to execute
$query1 = "SELECT * FROM banned_users";
...
?>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><?php echo $email;?></td>
                        <td>User</td>
                        <td><a href="unblockuser.php?id=<?php echo $id;?>">Unblock User</a></td>
                      </tr>
...
?>
                      <tr>
                        <td colspan="6" class="style3"><br><br><div align="left" class="style12"><?php echo "<center>Total Records of Blocked Users = <b>".$records." Users</b></center>"; ?> </div></td>
                      </tr>
                      </table>
                      <?php
