...
<center><h3>Available Jobs</h3></center>
...
?>
                  ...
                  <tbody>
                      <tr>
                        ...
                        <td><?php echo $min_qualification;?></td>
                        <td><?php echo $min_qualification;?></td>
                        <td><strong><a href="DeleteJob.php?id=<?php echo $id;?>">Delete</a></strong></td>
                      </tr>
...
?>
                      <tr>
                        <td colspan="6" class="style3"><br><br><div align="left" class="style12"><?php echo "<center>Total records of posted jobs = <b>".$records." Jobs</b></center>"; ?> </div></td>
                      </tr>
                      </table>
