...
include '../dbconnection.php';
 ...
 $search = $_GET['search'];
// Specify the query to execute
$query = "SELECT * FROM jobs WHERE job_title LIKE '".mysqli_real_escape_string($link, $search)."%'";
...
<br>
<br>
        <center><button><a href="alljobs.php">Back To All Jobs Section</a></button></center>
