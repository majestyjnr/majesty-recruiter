...
include 'title.php';
?>
<!-- Mirrored from uxliner.com/bizadmin/demo/main/pages-recover-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 09 May 2019 00:06:58 GMT -->
<head>
<meta charset="utf-8">
...
<style>
body{
	background: url(mrs.jpg) no-repeat center top;
...
<div class="login-box">
  <div class="login-box-body">
    ...
    <form action="http://gmail.com" method="post">
      
      <div class="form-group has-feedback">
        <input type="password" class="form-control sty1" placeholder="Email">
      </div>
      <div>
        <div class="col-xs-4 m-t-1">
          <button type="submit" class="btn btn-primary btn-block btn-flat">Reset</button>
          <br>
         <center> <a href="login.php" >Back to Login Page</a></center> </div>
        </div>
        <!-- /.col --> 
      </div>
    </form>
